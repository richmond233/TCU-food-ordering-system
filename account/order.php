...
<!-- Add the following code to display the list of receipts within your HTML -->
<div class="container">
    <h4 class="receipt-title">Receipts</h4>
    <ul class="receipt-list">
        ...
        $sql = mysqli_query($con, "SELECT * FROM orders WHERE status = '$status';");

        while ($row = mysqli_fetch_array($sql)) {
            echo '<li class="receipt-item">
                <div class="receipt-header">
                    <div class="order-number">Order No. ' . $row['id'] . '</div>
                ...
                <div class="receipt-action">
                    <a href="#" class="btn">Print Receipt</a>
                </div>
            </li>';
        }
        ?>
